...
// Public auth routes
router.post('/register', rateLimiter_1.sensitiveActionLimiter, authController_1.registerUser);
...
router.post('/forgot-password', rateLimiter_1.sensitiveActionLimiter, authController_1.forgotPassword);
router.post('/reset-password/:token', authController_1.resetPassword);
router.post('/google', authController_1.googleLogin);
router.post('/2fa/verify', rateLimiter_1.twoFactorLimiter, authController_1.verify2FACode);
