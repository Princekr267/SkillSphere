...
export const TwoFactorSetup: React.FC = () => {
  ...
  return (
    <Card variant="pink" className="text-left relative">
        ...
        {user.twoFactorEnabled ? (
          <div className="space-y-4">
            ...
            <Button
              ...
              disabled={loading}
              variant="coral"
              className="w-full flex items-center justify-center space-x-2 font-display uppercase font-bold"
            >
              {loading ? (
          ...
          <form onSubmit={handleVerifyAndEnable} className="space-y-4 font-sans animate-fade-in text-left">
            <p className="text-xs text-ink/75 leading-relaxed mb-2 font-bold">
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  placeholder="123456"
                  className="pl-9 text-sm tracking-widest font-mono font-bold bg-cream"
                />
              </div>
            </div>
