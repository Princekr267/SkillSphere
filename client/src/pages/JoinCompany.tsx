...
export const JoinCompany: React.FC = () => {
  ...
  return (
    <div className="flex-grow flex items-center justify-center px-2.5 sm:px-4 py-8 sm:py-16 bg-cream transition-colors duration-200 min-w-0">
      <Card variant="amber" className="w-full max-w-md p-4 sm:p-8 animate-slide-up space-y-5 min-w-0">
        ...
        <div className="bg-cream border-2 border-ink rounded-xl p-4 sm:p-5 shadow-retro-sm text-left min-w-0">
          <div className="flex items-center space-x-3 mb-2 min-w-0">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-[10px] font-mono text-ink/60 uppercase tracking-widest font-bold truncate">Company Access</p>
              <h1 className="text-lg sm:text-xl font-display font-black text-ink uppercase tracking-tight truncate">Join a Company</h1>
            </div>
          </div>
